...
if (forceCodecChange) {  // Set forceCodecChange to true if you want to change the codec forcefully
    options = { mimeType: 'video/webm;codecs=h264' };  // Change 'h264' to the desired codec
    ...
    log('isTypeSupported is not supported, using default codecs for the browser');
